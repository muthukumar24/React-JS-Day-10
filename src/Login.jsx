    ...
    return (
        <Container maxWidth="sm">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Button type='submit' variant='contained' color='primary' fullWidth style={{marginBottom: 10}}>
                    Login
                </Button>
                <Button type='submit' variant='contained' color='secondary' fullWidth onClick={() => userRegister()}>
                    Register
                </Button>
            </form>
